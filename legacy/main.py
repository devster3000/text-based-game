...
from legacy.game.locations import *
from legacy.game.inventory import *
from legacy.game.skills import *
from legacy.game.mechanics.combat import *
from legacy.game.map import *

# Location Imports
from legacy.locations.arena import *
from legacy.locations.house import *
from legacy.locations.blacksmith import *
from legacy.locations.tavern import *
from legacy.locations.field import *
from legacy.locations.castle import*
from legacy.locations.mines import *
from legacy.locations.market import *
from legacy.locations.well import *
from legacy.locations.fishing_pier import *
from legacy.locations.witch_hut import *
